...
public class OFAndroid {
		...
		try {
			...
			for(Field field: fields){
				...
				if(id == field.getInt(null)){
					Log.i("OF", "calling onMenuItemSelected");
    ...
    public static native void onCustom();
    
    public static native void passArray(byte[] data);
    
    public static native void passInt(int val);
